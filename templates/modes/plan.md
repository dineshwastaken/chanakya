...
- Read `.chanakya/manifest.yaml`, the current branch's `.chanakya/memory-bank/<branch>/active-context.md`
  and `progress.md`, and the relevant `.chanakya/knowledge/` concepts via `knowledge/index.md`.
...
- End by writing the plan into `.chanakya/memory-bank/<branch>/active-context.md` so the
  implementer can execute it in a fresh chat.
